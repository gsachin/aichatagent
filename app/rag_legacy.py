"""
LEGACY embedded RAG — University Admissions Assistant (Meridian)
================================================================
Verbatim copy of the pre-decoupling app/rag.py. Kept as the automatic
fallback backend (USE_MCP_RAG=off / auto-fallback); app/rag.py is now the
MCP-first dispatcher over this module. Only scripts/rebuild_rag_index.py
imports this module directly (it must always validate the store it builds).
