...
- **Rates (verified in code):** carrier audio arrives as 8 kHz µ-law, converted with `ulaw_to_pcm` (`app/voice_handler.py:111–118`); the utterance is upsampled 8 kHz → 16 kHz for the model (`app/voice_handler.py:412`); the model is `faster-whisper==1.2.1` with `small.en`, CUDA, `compute_type="int8"` (`app/voice_handler.py:73–79`, `app/platform.py:114–120`).
