...
- **Status:** **IMPLEMENTED - ACs verified; the 2+1 ORDERING INVARIANTS measured and holding; the turn cap in that window NOT met** · `test_us017_priority.py` 53/53 · 2+1 window `20260919T185350Z`: 200 turns, 0 dropped, 0 timeouts, both callers 100/100, **40/40 background units deferred, 0 started during a voice turn** — and **DISCARDED for any latency claim: 146 of 198 turns over the 3,000 ms cap**, so `TAC-5` remains open. The two halves are stated separately because they are different claims and only one holds · DoD 4/10
